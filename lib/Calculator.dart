            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    CalcKey(alu:_alu, keyString: 'AC', color: operationkeycolor,),
                    CalcKey(alu:_alu, keyString: '+/-', color: operationkeycolor,),
                    CalcKey(alu:_alu, keyString: '%', color: operationkeycolor,),
                    CalcKey(alu:_alu, keyString: '\u00F7', color: operationkeycolor,),
                ...
                Row(
                  ...
                  // Second row of keys
                  children: <Widget>[
                    CalcKey(alu:_alu, keyString: '7', color: keycolor,),
                    CalcKey(alu:_alu, keyString: '8', color: keycolor,),
                    CalcKey(alu:_alu, keyString: '9', color: keycolor,),
                    CalcKey(alu:_alu, keyString: '\u00D7', color: operationkeycolor,),
                ...
                Row(
                  mainAxisSize: MainAxisSize.min,
                  children: <Widget>[
                    CalcKey(alu:_alu, keyString: '4', color: keycolor,),
                    CalcKey(alu:_alu, keyString: '5', color: keycolor,),
                    CalcKey(alu:_alu, keyString: '6', color: keycolor,),
                    CalcKey(alu:_alu, keyString: '+', color: operationkeycolor,),
                  ],
                ),
                // Row 4
                ...
                Row(
                  mainAxisSize: MainAxisSize.min,
                  children: <Widget>[
                     CalcKey(alu:_alu, keyString: '1', color: keycolor,),
                    CalcKey(alu:_alu, keyString: '2', color: keycolor,),
                    CalcKey(alu:_alu, keyString: '3', color: keycolor,),
                    CalcKey(alu:_alu, keyString: '-', color: operationkeycolor,),
                ...
                Row(
                  ...
                  mainAxisSize: MainAxisSize.min,
                  children: <Widget>[
                    CalcKey(alu:_alu, keyString: '0', color: keycolor, constraints: zerokeyconstraints,),
                    CalcKey(alu:_alu, keyString: '.', color: keycolor,),
                    CalcKey(alu:_alu, keyString: '=', color: operationkeycolor,),
